export const translations = {
  en: {
    ...
    home_heading: "Serving Nellore — Committed to Development",
    home_para1:
      "Focused on the development and welfare of the Nellore Rural constituency, this site shares initiatives, programs, and ways to connect with Kotamreddy Sridhar Reddy’s office for assistance and participation.",
    ...
    info_card3_desc:
      "Nellore Election Result 2024 LIVE Updates Highlights released: Kotamreddy Sridhar Reddy of TDP Wins",
    about_us: "About Us",
    about_us_desc:
    ...
    born: "Born:",
    born_details: "26 September 1965 (age 60) \nNellore, Andhra Pradesh, India",
    ...
    copyright:
      "© Copyright 2024 | All Rights Reserved by Kotamreddy Sridhar Reddy",
    aim_title: "Aim",
    aim_desc:
      "As a committed Member of the Legislative Assembly (MLA) from Nellore Rural, Kotamreddy Sridhar Reddy focuses on inclusive development and improving the quality of life for his constituents. His priorities include agricultural support, youth empowerment, education, healthcare, and essential infrastructure.",
    ...
    blood_donation_desc:
      "Led multiple blood donation drives through KSR Foundation, encouraging youth participation.",
  ...
  te: {
    ...
    home_heading: "సేవలో నెల్లూరు — అభివృద్ధికి అంకితం",
    home_para1:
      "నెల్లూరు రూరల్ నియోజకవర్గం అభివృద్ధి మరియు సంక్షేమంపై దృష్టి సారించి, ఈ సైట్ ద్వారా కోటం రెడ్డి శ్రీధర్ రెడ్డి గారి కార్యాలయంతో ఎలా సంబంధాలు ఏర్పరచుకోవచ్చో, కార్యక్రమాల వివరాలు మరియు పాలసీ సూచనలు తెలుసుకోగలరు.",
